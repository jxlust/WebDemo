...
(function(factory) {
    ...
    defaults = {
        allowDropdown: true,       // 是否允许下拉
        autoHideDialCode: true,    // 如果输入中只有拨号代码：blur时删除它，focus时重新添加它
        autoPlaceholder: "polite", // 添加在所选国家例数输入占位符
        customPlaceholder: null,   // 修改自动占位符
        dropdownContainer: "",     // 附加菜单到特定元素
        excludeCountries: [],      // 不要显示这些国家
        formatOnDisplay: true,     // 在初始化过程中格式化的输入的值
        geoIpLookup: null,         // 更多的查找功能
        initialCountry: "",        // 初始国家
        nationalMode: true,        // 是否插入国际拨号码
        onlyCountries: [],         // 仅显示这些国家
        placeholderNumberType: "MOBILE",  // 数字类型用于占位符
        preferredCountries: ["cn","us"],  // 优先显示的国家
        separateDialCode: false,   // 在选定的标记旁边显示国家拨号码
        utilsScript: ""            // 指定要启用验证的js路径
    }, keys = {
        UP: 38,
        DOWN: 40,
        ENTER: 13,
